...
- The increase in young people's sudden-death rate.
...
- A beautiful equation (proved by myself several months ago):
  ...
  cause: $n^{3}=n^{2} \cdot n=n \cdot\left(n^{2}-n\right)+n^{2}=n \cdot\left(n^{2}-n\right)+\sum^{n} 2 i-1=\sum^{n} n^{2}-n+2 i-1$,
